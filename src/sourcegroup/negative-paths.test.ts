 ...
 * | `bnf-sru` / `gallica-ark-resolver` | n/a                                                    | bnf-sru.test.ts / gallica-ark-resolver.test.ts: zero-record/not-found response -> `null`/`[]`; HTTP/parse failures fail loud (support layer under inventory/verify-member's "dead ARK") | n/a                                                                              | n/a                                                                                   | n/a                                                                          | n/a (single documented mechanism; no fallback)  |
