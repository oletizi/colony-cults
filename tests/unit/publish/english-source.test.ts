 ...
 *
 * This file covers the ocrTranscription DISCLOSURE-RECORDING/MERGE theme
 * (AUDIT-02: single-issue recording; AUDIT-06: cross-issue conflict fails
 * loud). The companion opts.machineAssist SEED-CONTAMINATION theme
 * (AUDIT-08/11, English + French) lives in
 * `english-source-machine-assist.test.ts` -- split out of this originally
