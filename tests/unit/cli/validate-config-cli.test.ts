...
describe('bib validate-config (T018)', () => {
  ...
  describe('every failure condition reaches the CLI surface (SC-005)', () => {
    const cases: readonly [string, string, string, string][] = [
      ...
      ['INV-11 (AUDIT-20)', 'validate-profile-corpus-mismatch', 'empty', 'profile-corpus-filename-mismatch'],
      ['INV-11 (AUDIT-10)', 'validate-profile-default-sources', 'validate-valid', 'profile-default-source-nonconforming'],
      ['INV-11 (AUDIT-10)', 'validate-profile-default-sources', 'validate-valid', 'profile-unknown-default-source'],
