...
- [x] T007 [tier:fast] [US1] Unit test: an English fixture page with an empty OCR segment and no corrected `pNNN.fr.txt` makes `loadArchivePage` **throw naming the page** (C5, FR-007) — the blank-recto tolerance does not apply on the English path.
