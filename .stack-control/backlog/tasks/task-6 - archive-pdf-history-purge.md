...
<!-- SECTION:NOTES:BEGIN -->
Closed: Resolved by impl:feature/archive-object-store (shipped+closed): masters migrated to B2 and JPEG blobs purged from archive git history (operator-confirmed done).
<!-- SECTION:NOTES:END -->
